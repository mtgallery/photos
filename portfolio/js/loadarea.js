    ...
    $setMore.click(function(){
        ...
        if(loopCont < maxNum){
            $.each(new Array(loadNum),function(i){
                $setArea.append('<div class="list list-item list-mv07 mv07"><a href="https://www.behance.net/tmizumot0430"' + ' target="_blank"><div class="photo" style="background-image:url(images/works/img' + ((childLengh)+((i)+1)) + '.png)" /></a>');
            });
